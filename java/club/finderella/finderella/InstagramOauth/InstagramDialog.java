package club.finderella.finderella.InstagramOauth;
...
public class InstagramDialog extends Dialog {
    ...
    static final float[] DIMENSIONS_PORTRAIT = {280, 420};    // width, height
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //addContentView(mContent, new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.WRAP_CONTENT));
         addContentView(mContent, new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, (int) (dimensions[1] * scale + 0.5f))); // width,height
